...
=======
      ...
      cloud_file = CloudFile.create! params.require(:cloud_file).permit(:name, :asset, :md5, :content_type, :filesize, :description, :rating, :nsfw, :bucket_id, :folder_id, :info_url, :tags, :metadata)
>>>>>>> parent of 553c6af... - edited create tags migration so private is false by default
